...
?>
    ...
    <section id="guide-header">
      <h1>Travel Guide</h1>
      <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/travel-icon.svg" class="guide-header-icon" alt="Travel Guide">
    </section>
    ...
    <section id="guide-posts">
      <div class="container">
        ...
        <?php $loop = new WP_Query( array( 'post_type' => 'travel_guide_posts', 'orderby' => 'post_id', 'order' => 'DES', 'posts_per_page' => -1 ) ); ?>
